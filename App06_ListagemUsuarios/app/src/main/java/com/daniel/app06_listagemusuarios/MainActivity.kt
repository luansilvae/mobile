package com.daniel.app06_listagemusuarios
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val lista = mutableListOf<Usuario>(
            Usuario(nome="Joseffe Klimber", email="joseffe@Kliber.com", stack= Stack.BACKEND, senioridade= Senioridade.SENIOR, foto=resources.getDrawable(R.drawable.bran)),
