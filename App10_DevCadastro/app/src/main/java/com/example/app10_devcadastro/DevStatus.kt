...
class UsuarioAdapter(var listaUsuario: MutableList<Dev>, var context: Context): RecyclerView.Adapter<UsuarioAdapter.ItemViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.txtStack.text = listaUsuario[position].especialidade.nome
        holder.txtSenioridade.text = listaUsuario[position].nivel.nome
